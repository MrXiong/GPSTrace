package com.jgw.gpstrace.scan.voice;
...
/**
 * Created by linpg on 2016/12/19.
 */
public class VoiceHelp {
    ...
    public VoiceHelp(Context context, boolean playBeep, boolean vibrate) {
        super();
    ...
    private void initial() {
        ...
        loadId1 = mSoundPool.load(mContext, R.raw.errbeep, 1);
